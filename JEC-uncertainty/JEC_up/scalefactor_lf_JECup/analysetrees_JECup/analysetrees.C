...
void analysetrees(const TString &datalist,const TString &mclist){
  ...
  ///////////////////////
  //Get PtAveWeights
  TFile* f_ptaveweight=new TFile("~/qcd_dijets/JEC-uncertainty/JEC_down/PtAveWeight_JECdown/PtAveWeight_JECdown/ptaveweight.root");
  TH1F* h_ptaveweight = (TH1F*)f_ptaveweight->Get("PtAveWeight");
  TFile* f_PUWeight=new TFile("~/qcd_dijets/JEC-uncertainty/JEC_down/PU_Reweighting_JECdown/pu_weight_JECdown/PUWeight.root");
