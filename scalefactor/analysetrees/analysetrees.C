...
//   datachain->SetBranchAddress("Jet_NSV",Jet_NSV_data);
  ...
  TH1F* h_ptave_data=new TH1F("PtAve_data_wo_dijetselec","PtAve_data_wo_dijetselec",80,0,1000);
  h_ptave_data->SetDrawOption("histe0");
  TH1F* h_ptave2_data=new TH1F("PtAve_data_w_dijetselec","PtAve2_data_w_dijetselec",80,0,1000);
  h_ptave2_data->SetDrawOption("histe0");
  //loop over all events
