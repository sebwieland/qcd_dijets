...
void ptavetest(TFile *histos){
  ...
  TH1F* h_ptave_mc_wo_dijetselec = (TH1F*)histos->Get("PtAve_mc_wo_dijetselec");
  TH1F* h_ptave_data_wo_dijetselec = (TH1F*)histos->Get("PtAve_data_wo_dijetselec");
  h_ptave_data_w_dijetselec->Divide(h_ptave_mc_w_dijetselec);
  h_ptave_data_wo_dijetselec->Divide(h_ptave_mc_wo_dijetselec);
  ...
  c->cd();
  h_ptave_data_wo_dijetselec->Draw("histe0");
  line->Draw("same");
  c->SaveAs("ptavetest_wo_dijetselec.png");
