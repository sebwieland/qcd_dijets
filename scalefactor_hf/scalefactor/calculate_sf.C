...
//   }
  ...
  char xtitle_hf[]="CSV probe Jet (LF)";
...
//       h_lf[i][j]->Sumw2();
  ...
  //     //draw histos
      ...
      padratio_hf->SetBottomMargin(1.1);
      padratio_hf->Draw();
      padratio_hf->cd();
      ...
      //set_ratioattributes  
      ratio_hf->GetYaxis()->SetNdivisions(510);
      ratio_hf->GetYaxis()->SetLabelSize(0.1);
      ratio_hf->GetXaxis()->SetTitle(xtitle_hf);
      ratio_hf->GetXaxis()->SetTitleSize(0.11);
      ratio_hf->GetXaxis()->SetNdivisions(510);
      ratio_hf->GetXaxis()->SetLabelSize(0.1);
      ...
      c1->SaveAs("CSV_ratio_hf_ptbin"+pt_counter+"_etabin"+eta_counter+".png");
      ...
      c2->SaveAs("diff_hf_ptbin"+pt_counter+"_etabin"+eta_counter+".png");
      ...
      hfsf->Write();
      hfsf->GetXaxis()->SetTitle("hfSF");
      c2->SaveAs("hfSF_ptbin"+pt_counter+"_etabin"+eta_counter+".png");
